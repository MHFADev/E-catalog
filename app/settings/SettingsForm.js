...
import { updateSellerStore, updateAccountAvatar, updateStorePhoto, updatePaymentMethods } from "./actions";
  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-2xl mx-auto px-4 py-10 md:py-14">
        ...
        {/* ===== METODE PEMBAYARAN ===== */}
        {seller && (
          <div className="bg-white rounded-2xl md:rounded-3xl border border-cream-warm shadow-sm mt-4">
